...
public class KSMCIManagerImpl<T extends IKSMCIManager<T,U>,U extends IKSMCI<U>>
    ...
    public U getKSMObject(String ksmObjectId) {
        return (U) KSMObjectServiceFactory.getKSMCIService(KSMCI_CLASS_IMPL , ksmObjectApiServiceProvider).find(ksmObjectId);
    }
}
